    ...
    <View style={{ flex: 1, paddingHorizontal: 10 }}>
      <ScrollView style={{ flex: 1 }}>
        <View style={{ padding: 10 }}>
          <Text  allowFontScaling={false} style={{ fontSize: 20, textAlign: "center", fontWeight: 700 }}>
            END USER LICENSE AGREEMENT
          </Text>
          <Text  allowFontScaling={false} style={{ textAlign: "center", paddingTop: 4 }}>
        ...
        <View style={{ paddingTop: 20, paddingBottom: 70 }}>
          <View style={{ paddingVertical: 4 }}>
            <Text  allowFontScaling={false} style={{ fontSize: 18, fontWeight: 600, paddingVertical: 8 }}>
              1. THE APPLICATION
            </Text>
            <Text>
