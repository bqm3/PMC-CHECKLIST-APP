    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.ul}>
        <Text style={styles.li}>
          <Text style={styles.strong}>Account</Text> means a unique account
          created for You to access our Service or parts of our Service.
        </Text>
        <Text style={styles.li}>
          <Text style={styles.strong}>Affiliate</Text> means an entity that
        ...
        <Text style={styles.li}>
          <Text style={styles.strong}>Application</Text> refers to Checklist,
          the software program provided by the Company.
        </Text>
        <Text style={styles.li}>
          <Text style={styles.strong}>Company</Text> (referred to as either "the
        ...
        <Text style={styles.li}>
          <Text style={styles.strong}>Device</Text> means any device that can
          access the Service such as a computer, a cellphone or a digital
          tablet.
        </Text>
        <Text style={styles.li}>
          <Text style={styles.strong}>Personal Data</Text> is any information
        ...
        <Text style={styles.li}>
          <Text style={styles.strong}>Service Provider</Text> means any natural
        ...
        <Text style={styles.li}>
          <Text style={styles.strong}>Usage Data</Text> refers to data collected
        ...
        <Text style={styles.li}>
          <Text style={styles.strong}>You</Text> means the individual accessing
      ...
      <View style={styles.ul}>
        ...
        <Text style={styles.li}>
          <Text style={styles.strong}>To manage Your requests:</Text> To attend
          and manage Your requests to Us.
        </Text>
        <Text style={styles.li}>
          <Text style={styles.strong}>For business transfers:</Text> We may use
        ...
        <Text style={styles.li}>
          <Text style={styles.strong}>For other purposes</Text>: We may use Your
      ...
      <View style={styles.ul}>
        ...
        <Text style={styles.li}>
          <Text style={styles.strong}>With Affiliates:</Text> We may share Your
        ...
        <Text style={styles.li}>
          <Text style={styles.strong}>With Your consent</Text>: We may disclose
